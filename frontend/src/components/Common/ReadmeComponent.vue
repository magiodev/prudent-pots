    ...
    <div class="modal-dialog">
      <div class="modal-body p-5" v-if="gameConfig">
        ...
        <p>Players can allocate tokens to any pot without a fee. Yet, reallocating tokens incurs a
          {{ gameConfig.fee_reallocation }}% fee. This reallocation fee contributes to the next game's pool, encouraging
        ...
        <p>The winning pot is determined by its specific rules, and players in this pot receive their proportional share
        ...
        <p class="mb-5 pb-5">Explore detailed gameplay examples and strategic insights at the <a
