<template>
  <div class="instructions container">
    <div class="row py-5">
      <div class="col-12">
        <h2>Prudent Pots Game Rules</h2>
        <p>Welcome to Prudent Pots, the ultimate experiment zone where degens meet to test their wits and
          strategies! Here, brilliant minds compete by betting on unique pots with simple yet intriguing winning rules.
          Are you ready to dive into the world of Prudent Pots and claim your share of the prize?</p>

        <hr/>

        <h3>Setup and Strategy</h3>
        <p>In Prudent Pots, players face off against each other by betting on 5 different pots. The goal is to guess which
        ...
        <p>Each round lasts for {{ gameDuration }}. Here's the twist: if any player makes a move within the last
          ...
          the round indefinitely as long as moves are made. Pure degeness!</p>
        <p>After the winners are determined, there will be a short break to set up raffle prizes and check the pots. The
          Prudent Pots admin will then restart the next game. If the admin hasn't restarted the game within the first hour,
        ...
        <p>A general rule that always applies is that a single pot cannot have more tokens allocated to it than the
          combined total of the other pots. This prevents degens from collectively targeting specific pots, such
          as the highest or the even/odd pots.</p>
        <p>No Cartels allowed in the experiment zone! So, plan your strategy wisely,
          or risk falling into the chaos of the Prudent Pots laboratory!</p>
        ...
        <p>The player who bets the most tokens and wins also gets an extra surprise: they win the raffle! The raffle
          prize could include a NFT and/or $NTRN tokens. Each game extension slightly reduces the tokens
        ...
        <p>Remember that none of this is financial advice. The game can be much more complex due to reallocations, real
          ...
          understand the rules fully before participating. By entering Prudent Pots, you accept that the outcomes are based
          on the rules of the game and that winning is never guaranteed. Enjoy the degeness, but keep your wits about
          you!</p>
              ...
              <div class="accordion-body">
                <div v-if="currentPage === 1">
                  ...
                  <ul>
                    ...
                    <li>This round is also funded with <strong>1 NFT</strong> and <strong>100
                      <CoinComponent/>
                    </strong> as the
                      raffle prize.
                    </li>
